                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                  ...
                                  <div class="row d-md-table-row text-center" style="width:60%">
                                    <div class="dropdown-item d-table-cell col-sm-12 col-md-4">
                                      <ul>                                                                       
                                        ...
                                        <li><a class="dropdown-item  text-white" href="{{ url('/center') }}">Zaragoza </a></li>
                                      </ul>
                                    </div>
                                    <div class=" dropdown-item d-table-cell col-sm-12 col-md-4">
                                      <ul>                                                                       
                                        ...
                                        <li><a class="dropdown-item" href="{{ url('/center') }}">Coslada </a></li>
                                      </ul>
                                    </div>
                                    <div class="dropdown-item d-table-cell col-sm-12 col-md-4">
                                      <ul>                                                                       
                                        <li>Valencia</li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="{{ url('/center') }}">Valencia</a></li>
                                      </ul>
                                    </div>
                                    <div class="dropdown-item d-table-cell col-sm-12 col-md-4">
                                      <ul>                                                                       
                                        <li>Barcelona</li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="{{ url('/center') }}">Barcelona</a></li>
                                        <li><a class="dropdown-item" href="{{ url('/center') }}">Otro</a></li>
                                      </ul>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <ul class="navbar-nav mL-auto ">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link btn btn-outline-warning my-2 mx-2 my-sm-1" href="{{ route('login') }}">Acceso Tocoto</a>
                                </li>
                            @endif
                            
                            @if (Route::has('register'))    
                                <li class="nav-item">
                                    <a class="nav-link btn btn-outline-warning my-2 mx-2 my-sm-1" href="{{ route('register') }}">Prueba 1 día</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
